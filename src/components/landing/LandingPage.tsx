...
import { ShoppingCart, Search, BarChart3, CreditCard, Zap } from "lucide-react";
...
export function LandingPage({
  ...
  const heroTextSize = device.isMobile
    ...
    <div className="flex min-h-dvh flex-col bg-background">
      <div className="flex flex-1 flex-col items-center justify-center px-4 py-16">
        ...
        >
          ...
          <div
            className={cn(
              "grid gap-3 mx-auto max-w-lg",
              device.isMobile ? "grid-cols-1" : "grid-cols-3 gap-6"
            )}
          >
            {[
          ...
          <Button
            ...
            className={cn(
              "rounded-xl px-8 font-display text-base",
              device.isTouch ? "min-h-[56px]" : "min-h-[48px]"
            )}
          >
